...
<div class="main-box">
	<form class="login-form" action="updatePassword" method="post">
		<div class="login-box">
			...
			<div class="input-box ">
				<input class="input-box-input" type="text" name="current_password" autocomplete="off" />
				<span class="input-box-focusUp" data-placeholder="현제 비밀번호"></span>
			</div>
			<div class="input-box ">
				<input class="input-box-input" type="text" name="update_password" autocomplete="off" />
				<span class="input-box-focusUp" data-placeholder="새로운 비밀번호"></span>
			</div>
			<div class="input-box">
				<span class="btn-show">
				...
				<span class="input-box-focusUp" data-placeholder="비밀번호 체크"></span>
			</div>
			...
			<div class="loginCheck-Box">
				<div class="loginCheck-Box2">
					...
					<button type="submit" value="login">비밀번호 수정</button>
				</div>
			</div>
		</div>	
	</form>
