...
<div class="main-box">
	<form class="login-form active" action="loginOK" method="post">
		<div class="login-box">
			...
			<div class="input-box">
				...
				<input class="input-box-input " type="password" name="password" onblur="add_has()"/>
	...
	<form class="SignUp-form active" action="joinOK" method="post">
		<div class="login-box">
			<div class="header-box">
				<a href="#">join-us</a>
			</div>
			...
			<div class="login-signUp">
				...
				<a class="toggleBtn3" href="login">Login</a>
			</div>
		</div>	
	</form>
