...
<div class="main-box">
	<div class="main-container2">
		<div class="contentView-box">
			<form action="upload" onsubmit="return confirm_check()">
				<div class="contentView-header-box">
					<div class="contentView-back upload-back">
						<a href="content?currentPage=${currentPage}" class="contentView-back-btn">
					...
					<div>
						<div class="upload-header-container">
							...
							<input type="text" class="upload-input-header2" name="title" placeholder="Title">
						</div>
						<div class="upload-header-container">
							<div class="upload-input-header" >
								카테고리 
						...
						<div class="upload-header-container">
							...
							<input type="text" class="upload-input-header2" name="image" placeholder="Image">
						</div>
					</div>
					<div id="uplaod_cnt" class="uplaod_cnt">0 / 4000</div>
				</div>
				<div class="contentView-content-box">
					<textarea id="comment" class="upload-input-textarea" name="content" placeholder="Content" wrap="physical" cols="40"></textarea>
				</div>
			</form>
		</div>
	</div>
